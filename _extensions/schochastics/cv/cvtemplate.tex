...
\vspace{\cvspace/2}
$if(additional-education.header)$
\subsection{$additional-education.header$}
$else$
...
$if(memberships.header)$
\section{$memberships.header$}
$else$
\section{Memberships}
$endif$
\vspace*{0.25em}
...
$if(fundingawarded.header)$
\section{$fundingawarded.header$}
$else$
